...
public class AspectCategory implements TransferDisplayCategory<AspectDisplay>
{
	private static final Text name = new TranslatableText("thuwumcraft.rei.category.aspects");

	@Override
	public void renderRedSlots(MatrixStack matrices, List<Widget> widgets, Rectangle bounds, AspectDisplay display, IntList redSlots)
	{
