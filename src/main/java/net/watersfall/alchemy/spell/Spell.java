...
public record Spell(SpellAction action, CastingType type, int castingTime, int cooldown, int color)
{
	...
	public static final Spell SNOW = REGISTRY.register(AlchemyMod.getId("snow"), new Spell(SpellAction.SNOW, CastingType.SINGLE, 5, 5, 0xCCCCCC));
	public static final Spell WATER = REGISTRY.register(AlchemyMod.getId("water"), new Spell(SpellAction.WATER, CastingType.CONTINUOUS, 10, 1, 0x0000FF));
	public static final Spell ICE = REGISTRY.register(AlchemyMod.getId("ice"), new Spell(SpellAction.ICE, CastingType.SINGLE, 10, 10, 0x7FD2FF));
