package com.watersfall.poisonedweapons.recipe;
...
import com.watersfall.poisonedweapons.item.LadleItem;
...
public class CauldronRecipe implements Recipe<BrewingCauldronInventory>
{
	...
	{
		return new Identifier(PoisonedWeapons.MOD_ID, "cauldron_recipe");
	}

	@Override
	public RecipeSerializer<?> getSerializer()
	{
		return PoisonedWeapons.CAULDRON_RECIPE_SERIALIZER;
	}

	@Override
	public RecipeType<?> getType()
	{
		return PoisonedWeapons.CAULDRON_RECIPE_TYPE;
	}
