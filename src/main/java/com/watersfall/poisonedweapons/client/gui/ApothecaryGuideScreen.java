package com.watersfall.poisonedweapons.client.gui;
...
{
	private static final Identifier TEXTURE = new Identifier(PoisonedWeapons.MOD_ID, "textures/gui/container/apothecary_guide_book.png");
