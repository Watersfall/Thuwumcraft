package com.watersfall.poisonedweapons.inventory.handler;

import com.watersfall.poisonedweapons.PoisonedWeapons;
import com.watersfall.poisonedweapons.item.ApothecaryGuideItem;
...
public class ApothecaryGuideHandler extends ScreenHandler
{
	...
	{
		super(PoisonedWeapons.APOTHECARY_GUIDE_HANDLER, syncId);
	...
	{
		return PoisonedWeapons.APOTHECARY_GUIDE_HANDLER;
	}
